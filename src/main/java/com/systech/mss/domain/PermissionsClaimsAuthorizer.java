...
@Entity
@Table(name = PermissionsClaimsAuthorizer.TB_NAME)
@Getter
@Setter
@NoArgsConstructor
public class PermissionsClaimsAuthorizer extends BaseModel  implements Serializable {
    @Transient
    public static final String TB_NAME = "claimsauthorizerperms";
