...
@Entity
@Table(name = PermissionsClaimsApprover.TB_NAME)
@Getter
@Setter
@NoArgsConstructor
public class PermissionsClaimsApprover extends BaseModel  implements Serializable {
    @Transient
    public static final String TB_NAME = "claimsapproverperms";
