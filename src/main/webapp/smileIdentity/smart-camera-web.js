...
smartCameraWeb.addEventListener('imagesComputed', (e) => {
    ...
    if (data){
        let partner_params=data.partner_params;
        let images=data.images;
        if (images){
            for (let i = 0; i < images.length; i++) {
                let image=images[i];
                if (image.image_type_id===2){
                    image64Bit=image.image;
                    localStorage.removeItem('selfie64BitString')
                    console.log('saving selfie')
                    localStorage.setItem("selfie64BitString",image64Bit)
                    // processSelfie();
                    break;
                }
            }
...
//     console.log(selfie);
//     $.ajax({
//         url: `${baseUrl}/api/smileIdentity/processSelfie`,
//         type: 'post',
//         dataType: 'json',
//         data: JSON.stringify(selfie),
//         headers: {
...
// let selfieMemberId=localStorage.getItem("selfieMemberId");
//
// let selfieUserId=localStorage.getItem("selfieUserId");
//
// let jobType=localStorage.getItem("jobType");
//
// function loadMemberDetails() {
//     $.ajax({
//         url: `${baseUrl}/api/getMemberDetailsAll/${selfieUserId}/${selfieMemberId}`,
//         dataType: 'json',
//         headers: {
//             'Content-Type': 'application/json',
//             'Accept': 'application/json'
...
//
//             selfie = {
//                 "userId":selfieMemberId,
//                 "jobId":"",
//                 "jobType":jobType,
//                 "imageType":2,
//                 "image": image64Bit,
//                 "idFirstName":obj.firstname,
//                 "idMiddleName":obj.surname,
//                 "idLastName":obj.othernames,
//                 "idCountry":"KE",
//                 "idType":"NATIONAL_ID",
//                 "idNumber":obj.idNo,
//                 "idDob":obj.dob,
//                 "idPhoneNumber":obj.cellPhone,
//                 "idConfirmed":"true"
//             };
//
//         },
...
<div hidden id='thanks-screen' class='flow center'>
  <div class='section | flow'>
    <h1>Selfie Taken Successfully, Close the window to process the selfie</h1>
...
class SmartCameraWeb extends HTMLElement {
    ...
    _publishSelectedImages() {
        ...
        this.thanksScreen.hidden = false; //close iframe
        // let wind=Ext.getcmp('takeSelfieWindow');
        // wind.destroy();
        // let win = window.parent.Ext.getCmp('takeSelfieWindow');
        // if(win){
        //     win[win.closeAction]();
        // }
    }
